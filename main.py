    ...
    def __init__(self, **kwargs):
        ...
        contenido = Label(
            text=(
                ...
                "4. [b]Guardado:[/b] Progreso automático.\n"
...
class MenuScreen(Screen):
    ...
    def actualizar_menu(self):
        ...
        # CORREGIDO: usar keys() en lugar de indices()
        try:
            completados = len(self.store.keys())
        except:
            completados = 0
        ...
        modulos = [
            "01: El Despertar", "02: Almacenes", "03: Variables",
            "04: Condicionales", "05: Bucles", "06: Funciones",
            "07: Listas", "08: Diccionarios", "09: Strings",
            "10: Operadores", "11: Debugging", "12: Retos Finales",
            "13: El Desafío", "14: El Maestro"
        ]
...
class CursoScreen(Screen):
    ...
    def verificar_codigo(self, titulo):
        ...
        if codigo:
            self.store.put(titulo, completado=True)
